...
function App() {
  ...
  return (
    <div className="bg-black font-sans space-y-12">
      ...
      {/* Title Section */}
      <Section className="w-full px-6 md:px-20 lg:px-40 bg-blue-800 text-white rounded-xl shadow-lg">
        <div className="w-full text-center">
          ...
          <a
            ...
            rel="noopener noreferrer"
             className="px-10 py-4 bg-yellow-500 text-black font-semibold rounded-full shadow-lg transform pulse-glow"
              >
             Register Now
          </a>
        </div>
      ...
      <Section
        id="about"
        className="w-full px-6 md:px-20 lg:px-40 py-20 bg-blue-800 text-white rounded-xl shadow-lg"
      >
      ...
      <Section id="speakers" className="w-full px-6 md:px-12 lg:px-20 py-24 bg-blue-800 text-white rounded-xl shadow-lg flex flex-col">
        ...
        <div className="flex flex-col md:flex-row items-center justify-center md:justify-between w-full gap-12">
          {/* Speaker 1 */}
          <div className="bg-white text-black p-8 rounded-3xl shadow-2xl w-full md:w-1/2 transform transition duration-500 flex flex-col items-center hover:drop-shadow-[0_0_16px_rgba(251,113,133,0.6)] hover:scale-105">
      ...
      <OrganizersSection id="organizers" className="my-extra-styles" />
       ...
       {/* Resources */}
      <Section id="resources" className="w-full px-6 md:px-20 lg:px-40 bg-blue-800 text-white rounded-xl shadow-lg">
