  ...
  const schedule = [
    ...
    },
    {
      ...
      items: [
        ...
        { time: "9:00 – 9:30", title: "Quick Recap", description: "A brief review of Day 1's key takeaways to get everyone back up to speed." },
        { time: "9:30 – 10:40", title: "Talk: Quantum Applications", description: "Explore the practical uses of quantum computing in various industries today and in the future." },
        { time: "10:40 – 11:00", title: "Break", description: "Recharge with a short break." },
        { time: "11:00 – 12:30", title: "Workshop: Building Circuits in Qiskit", description: "A workshop focused on building fundamental quantum circuits like the Bell state." },
        { time: "12:30 – 12:50", title: "Challenge: Bell State Circuit", description: "A hands-on challenge to apply what you've learned and build a Bell state circuit. Prizes up for grabs !!" },
        { time: "12:50 – 13:10", title: "IBM Speaker Talk + Q&A", description: "A special keynote from an IBM expert, followed by a Q&A session." },
        { time: "13:10 – 13:30", title: "Break", description: "Recharge with a short break." },
        { time: "13:30 – 14:45", title: "Workshop: Building a QRNG", description: "Explore how quantum superposition enables true randomness by building a Quantum Random Number Generator!" },
        { time: "14:45 – 15:05", title: "Closing Ceremony", description: "Certificates, group photo, and Swag distributions !!!" },
      ],
